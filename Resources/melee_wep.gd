...
static func getHitbox(_hitbox: Enums.MeleeWeaponHitboxSize) -> CollisionShape3D:
	match _hitbox:
		Enums.MeleeWeaponHitboxSize.NONE:
			return preload("res://Resources/hitboxes/EmptyHitbox.tscn").instantiate()
		Enums.MeleeWeaponHitboxSize.SMALL:
			return preload("res://Resources/hitboxes/SmallHitbox.tscn").instantiate()
		Enums.MeleeWeaponHitboxSize.LARGE:
			return preload("res://Resources/hitboxes/LargeHitbox.tscn").instantiate()
	return preload("res://Resources/hitboxes/EmptyHitbox.tscn").instantiate()
